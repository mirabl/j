...
190. Reverse Bits   Add to List QuestionEditorial Solution  My Submissions
Total Accepted: 87126
Total Submissions: 295179
Difficulty: Easy
Contributors: Admin
...
alias a='g++ -Wall -std=c++11 -g reverse_bits.cpp && ./a.out'
*/
#include <iostream>
#include <cstdint>
...
def rev(x):
  ...
  for i in range(8):
     y = y | (((x >> i) & 1) << (7 - i))
  return y
','.join(["0x%x" % rev(x) for x in range(256)])

*/
int main() {
	cout << reverseBits(43261596) << " " << 964176192 << endl;
	cout << reverseBits(0) << " " << 0 << endl;
	cout << reverseBits(1) << " " << (1ull<<31) << endl;
}